...
echo "----------------------------------------------------------------------------------------"
echo "docker run --network host -t $TAG python3 $repodir/test/test_functional.py              "
echo "----------------------------------------------------------------------------------------"
echo "----------------------------------------------------------------------------------------"
echo "Load Test                                                                               "
echo "----------------------------------------------------------------------------------------"
echo "docker run -t $TAG locust --host=http://localhost:8089 -f $repodir/test/test_load.py    "
echo "Use the web browser - http://localhost:8089                                             "
echo "Start the test by specifying number of users to simulate and users/sec                  "
echo "----------------------------------------------------------------------------------------"
echo "                                                                                        "
